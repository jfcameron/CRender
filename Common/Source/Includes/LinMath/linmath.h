...
//static   void mat4x4_rotate(mat4x4 R, mat4x4 M, float x, float y, float z, float angle) //////MODIFIED, DOESNT WORK//////////////////////
//{
//	float s = sinf(angle);
//	float c = cosf(angle);
//	vec3 u = {x, y, z};
...
//static   void mat4x4_invert(mat4x4 T, mat4x4 M)                       //////////////////DID NOT MOD, DOES NOT COMPILE//////////////////////////////
//{
//	float s[6];
//	float c[6];
...
//}
//static   void mat4x4_orthonormalize(mat4x4 R, mat4x4 M)                   ////////////////////NOT MODIFIED, DOESNT WORK////////////////
//{
//	mat4x4_dup(R, M);
//	float s = 1.;
//	vec3 h;
...
static   void quat_rotate(quat r, float angle, vec3 axis) //Modified, moved variable dec i 
{
	vec3 v;
    int i;
